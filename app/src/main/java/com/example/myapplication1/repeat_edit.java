...
public class repeat_edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //事件的属性
        for(int i=0;i<8;i++){
            check[i].setChecked(eventCatalog.getCatalog().get(position).getRepeat().getIfCheck()[i]);
        }
        switch_repeat.setChecked(eventCatalog.getCatalog().get(position).getRepeat().getSwitch_repeat());
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(repeat_edit.this, activity_edit_event.class);
